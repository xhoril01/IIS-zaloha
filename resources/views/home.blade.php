    ...
    <!--<div id="graph"></div>-->
        <header>
            <div>
                ...
                <div class="row justify-content-between align-items-center bg-gray-100 dark:bg-gray-900" style="height: 100px; margin-top: 10px; margin-bottom: 10px; ">
                    <div class="col-4 position-relative">
                        <img src="{{ asset('img/nurch-logo-og.png') }}" class="rounded translate-middle position-absolute top-0 start-50 " alt="logo1" style="height: 100px">
                    </div>

                    <div class="col-4 position-relative">
                        <img src="{{ asset('img/logo.png') }}" class="rounded translate-middle position-absolute top-0 start-50 " alt="logo2" style="height: 100px; padding-top: 10px; padding-bottom: 10px; ">
                    </div>

                    @if (Route::has('login'))
                    <div class="col-2 position-relative ">
                        @auth
                            <a href="{{ url('/home') }}" class="btn btn-outline-secondary btn-sm fs-5" role="button">Účet</a>
                        @else
                            <a href="{{ route('login') }}" class="btn btn-outline-secondary btn-sm fs-5" role="button">Prihlásenie</a>
                        @endauth
                    </div>
                    @endif
                </div>
        ...
        <div class="container">
            <div class="row justify-center align-items-center">
                <div class="col-4">
                    <img src="{{ asset('img/woman.jpg') }}" class="img-fluid rounded" alt="img">
                </div>
